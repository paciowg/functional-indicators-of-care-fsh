...
* #body-functions #sensory-functions-and-pain #seeing-and-related-functions "Seeing and related functions" "Seeing and related functions."
* #body-functions #sensory-functions-and-pain #hearing-and-vestibular-functions "Hearing and vestibular functions" "Hearing and vestibular functions."
* #body-functions #sensory-functions-and-pain #additional-sensory-functions "Additional sensory functions" "Additional sensory functions."
* #body-functions #sensory-functions-and-pain #pain "Pain" "Pain"
...
* #body-functions #digestive-metabolic-endocrine-systems #functions-related-to-the-digestive-system "Functions related to the digestive system" "Functions related to the digestive system."
* #body-functions #digestive-metabolic-endocrine-systems #functions-related-to-the-digestive-system #ingestion-functions "Ingestion functions" "Functions related to taking in and manipulating solids or liquids through the mouth into the body."
* #body-functions #digestive-metabolic-endocrine-systems #functions-related-to-the-digestive-system #digestive-functions "Digestive functions" "Functions of transporting food through the gastrointestinal tract, breakdown of food and absorption of nutrients."
* #body-functions #digestive-metabolic-endocrine-systems #functions-related-to-the-digestive-system #assimilation-functions "Assimilation functions" "Functions by which nutrients are converted into components of the living body."
* #body-functions #digestive-metabolic-endocrine-systems #functions-related-to-the-digestive-system #defecation-functions "Defecation functions" "Functions of elimination of wastes and undigested food as faeces and related functions."
* #body-functions #digestive-metabolic-endocrine-systems #functions-related-to-the-digestive-system #weight-maintenance-functions "Weight maintenance functions" "Functions of maintaining appropriate body weight, including weight gain during the developmental period."
* #body-functions #digestive-metabolic-endocrine-systems #functions-related-to-the-digestive-system #sensations-associated-with-the-digestive-system "Sensations associated with the digestive system" "Sensations arising from eating, drinking and related digestive functions."
...
* #activities-and-participation #communication #communication-receiving "Communication - receiving" "Communication - receiving."
* #activities-and-participation #communication #communication-producing "Communication - producing" "Communication - producing."
* #activities-and-participation #communication #conversation-and-use-of-communication-devices-and-techniques "Conversation and use of communication devices and techniques" "Conversation and use of communication devices and techniques."
