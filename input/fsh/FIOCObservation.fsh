...
**********/
Profile:        FIOCObservation
Parent:         Observation
Id:             fioc-observation
Title:          "Functional Indicators of Care Observation"
...
* component ^short = "Currently not used in FIOCObservation."
...
* basedOn ^short = "Currently not used in FIOCObservation."
* partOf ^short = "Currently not used in FIOCObservation."
...
* focus ^short = "Currently not used in FIOCObservation."
* issued ^short = "Currently not used in FIOCObservation."
* interpretation ^short = "Currently not used in FIOCObservation."
* bodySite ^short = "Currently not used in FIOCObservation."
* method ^short = "Currently not used in FIOCObservation."
* specimen ^short = "Currently not used in FIOCObservation."
* device ^short = "Currently not used in FIOCObservation."
* referenceRange ^short = "Currently not used in FIOCObservation."
* hasMember ^short = "Currently not used in FIOCObservation."
