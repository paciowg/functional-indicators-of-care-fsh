...
**********/
Profile:        FIOCCollection
Parent:         Observation
Id:             fioc-collection
Title:          "Functional Indicators of Care Collection"
...
* category[functioning] from FIOCFunctioningVS (extensible)
* category[functioning].coding = FIOCFunctioningCS#functioning "Functioning"
* category contains FIOCDomain 0..*
* category[FIOCDomain] from FIOCCategoryVS

* effective[x] 1..1
* effective[x] only dateTime or Period

* hasMember only Reference(FIOCObservation)
* hasMember MS
...
* component ^short = "Currently not used in FIOCCollection."
* basedOn ^short = "Currently not used in FIOCCollection."
* partOf ^short = "Currently not used in FIOCCollection."
...
* focus ^short = "Currently not used in FIOCCollection."
* issued ^short = "Currently not used in FIOCCollection."
* dataAbsentReason ^short = "Currently not used in FIOCCollection."
* interpretation ^short = "Currently not used in FIOCCollection."
* bodySite ^short = "Currently not used in FIOCCollection."
* method ^short = "Currently not used in FIOCCollection."
* specimen ^short = "Currently not used in FIOCCollection."
* device ^short = "Currently not used in FIOCCollection."
* referenceRange ^short = "Currently not used in FIOCCollection."
...
* value[x] only Reference(FIOCUseOfDevice)
